  ...
  return (
    ...
    >
      ...
      <div className="px-4 pt-3 pb-4 flex flex-col flex-1 gap-3">
        {/* Title */}
        <div>
          <p className="text-xs text-gray-500 uppercase tracking-wider mb-0.5">{game.developer}</p>
          <div className="flex items-center justify-between gap-2">
            <h2 className="text-lg font-bold leading-tight" style={{ color: game.glowColor }}>
              {game.name}
            </h2>
            <PopularityBadge
        ...
        {allSeasons.length > 0 ? (
          ...
          <div className="flex-1 flex flex-col justify-center py-2">
            <p className="text-gray-500 text-sm mb-3">{t("unavailable")}</p>
            <a
