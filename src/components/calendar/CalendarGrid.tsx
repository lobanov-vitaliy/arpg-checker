...
function CalendarGridInner({
  ...
  return (
    <div>
      ...
      {/* ── Weeks ── */}
      <div className="grid grid-cols-7 border-l border-t border-gray-800 backdrop-blur-md bg-gray-900/30 rounded-lg overflow-hidden">
        {weeks.flat().map((date, i) => {
          ...
          return (
            <div
              key={i}
              className={`min-h-28 border-r border-b border-gray-800 p-1.5 ${!isCurrentMonth ? "bg-gray-950/60" : ""}`}
            >
